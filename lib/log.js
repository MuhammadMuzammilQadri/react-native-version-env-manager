...
module.exports = {
  ...
  imp(message, importantMessage, level = 0, asString = false) {
    let _importantMessage = this.echo(importantMessage, 0, chalk.magenta, true);
    return this.echo(message + _importantMessage, level, null, asString);
  },
